...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div id="ms-list-'+ instance.listNumber +'" class="ms-options-wrap"><button type="button" class="btn dropdown-toggle btn-default"><span>None Selected</span></button><div class="ms-options" id="options-'+instance.options.nameSuffix+'"><ul></ul></div></div>');
            ...
            if( instance.options.search ) {
				if (instance.options.validateCloseOnly)
				{
					optionsList.before('<div class="ms-search pt-2 p-2" id="search-'+instance.options.nameSuffix+'"><a href="#" onclick="$(\'.ms-options-wrap\').removeClass(\'ms-active\');return false;" class="btn btn-default btn-sm" style="text-align:center;">'+ instance.options.texts.validateFilter + '</a></div>');
				} else {
					selectVals = [];
					...
					optionsList.before('<div class="ms-search pt-2 p-2" id="search-'+instance.options.nameSuffix+'"><a href="#" onclick="$(this).closest(\'form\').submit();return false;" class="btn btn-default btn-sm" style="text-align:center;">'+ instance.options.texts.validateFilter + '</a>' + (selectVals.length > 0 ? '&nbsp;<a href="' + instance.options.desactivateUrl + '" class="btn btn-danger btn-sm btn-desactivate" id="desactivateButton">'+ instance.options.texts.disableFilter +'</a>' : '') + '</div>');
				}				
        ...
        _updatePlaceholderText: function(){
			...
			if( selOpts.length) {
				$('#ms-list-'+ instance.listNumber).find('button').addClass('btn-danger');
				$('#ms-list-'+ instance.listNumber).find('button').removeClass('btn-default');
			} else {
				$('#ms-list-'+ instance.listNumber).find('button').removeClass('btn-danger');
				$('#ms-list-'+ instance.listNumber).find('button').addClass('btn-default');
			}
        ...
        _addOption: function( container, option ) {
            ...
            var thisCheckbox = $('<input>', {
				...
				name : instance.options.nameSuffix + '_' + option.value,
                value: option.value
            });
