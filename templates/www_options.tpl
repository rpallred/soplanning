	...
	<div class="form-group row col-md-12 align-items-center">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="{$BASE}/feries" class="btn btn-default" ><i class="fa fa-plane fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuFeries#}</a>
					<a href="{$BASE}/status" class="btn btn-default" ><i class="fa fa-tags fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuStatus#}</a>
					<a href="{$BASE}/lieux" class="btn btn-default" ><i class="fa fa-map-marker fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuLieux#}</a>
					<a href="{$BASE}/ressources" class="btn btn-default" ><i class="fa fa-plug fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuRessources#}</a>
				</div>
			</div>
		</div>
	</div>
	<div class="form-group row col-md-12 mt-2" id="optionsRow">
		<div class="col-3">
			<div  class="nav flex-column nav-pills soplanning-box" role="tablist" aria-orientation="vertical" id="myTab">
				...
				<a class="nav-link {if isset($smarty.get.tab) && $smarty.get.tab eq "authentication"}active{/if}" id="authentication-tab" data-toggle="pill" href="#authentication" role="tab" aria-controls="authentication" aria-selected="false">{#options_authentication#}</a>
		...
		<div class="col-9">
			<div class="tab-content">
				<div class="tab-pane fade show {if !isset($smarty.get.tab) || $smarty.get.tab == 'param-global' || $smarty.get.tab eq ""}active{/if}" id="param-global" role="tabpanel" aria-labelledby="param-global-tab">
					<div class="soplanning-box">
						<form action="process/options" method="POST" class="form-horizontal" enctype="multipart/form-data" id="setupForm">
							...
							<fieldset>
								...
								<div id="optionscle" style="display:{if $smarty.const.CONFIG_SOPLANNING_OPTION_ACCES ==2}block{else}none{/if};">
											...
											<div class="form-group row col-md-12 align-items-center">
												...
												<a href="{if $smarty.const.CONFIG_SOPLANNING_URL == ''}{$urlSuggeree}planning?public=1&cle={$smarty.const.CONFIG_SECURE_KEY}" target="_blank">{$urlSuggeree}{else}{$smarty.const.CONFIG_SOPLANNING_URL}{$sep}planning?public=1&cle={$smarty.const.CONFIG_SECURE_KEY}" target="_blank">{$smarty.const.CONFIG_SOPLANNING_URL}{$sep}{/if}planning?public=1&cle={$smarty.const.CONFIG_SECURE_KEY}</a>
												</div>
											</div>
										</div>
				...
				<div class="tab-pane {if isset($smarty.get.tab) && $smarty.get.tab eq "param-modules"}active{/if}"" id="param-modules">
					<div class="soplanning-box">
						<form action="process/options" method="POST">
					...
					<div class="soplanning-box">
						<form action="process/options" method="POST">
							...
							<fieldset>
								...
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label">{#options_joursInclus#} :</label>
									<div class="col-md-8 form-inline-block">
										{assign var=tabJours value=$smarty.const.CONFIG_PLANNING_DAYS_OF_WEEK_DISPLAY|json_decode:true}
										{section name="loopJours" loop=7}
											<div style="display:inline-block;width:90px">
											{assign var=nomJour value="day_"|cat:$smarty.section.loopJours.iteration}
											{$smarty.config.$nomJour}
											</div>
											<input style="display:inline-block;margin-right:5px" type="checkbox" name="planning_jours_inclus[]" value="{$smarty.section.loopJours.iteration}" id="lundi_inclus" {if $tabJours[$smarty.section.loopJours.iteration]['inclus'] eq "1"}checked="checked"{/if}>
											<label style="display:inline-block;margin-bottom:0px" for="lundi_inclus">{#jours_inclus#}</label>
											<div style="display:inline-block" title="{#options_aide_jours_inclus#}" class="cursor-help tooltipster"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
											<input style="display:inline-block;margin-left:30px;margin-right:5px" type="checkbox" name="planning_jours_affiches[]" value="{$smarty.section.loopJours.iteration}" id="lundi_affiche" {if $tabJours[$smarty.section.loopJours.iteration]['affiche'] eq "1"}checked="checked"{/if}>
											<label style="display:inline-block;margin-bottom:0px" for="lundi_affiche">{#jours_affiche#}</label>
											<div style="display:inline-block" title="{#options_aide_jours_affiche#}" class="cursor-help tooltipster"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
											<input style="display:inline-block;margin-left:30px;margin-right:5px" type="checkbox" name="planning_jours_grises[]" value="{$smarty.section.loopJours.iteration}" id="lundi_grise" {if $tabJours[$smarty.section.loopJours.iteration]['grise'] eq "1"}checked="checked"{/if}>
											<label  style="display:inline-block;margin-bottom:0px" for="lundi_grise">{#jours_grise#}</label>
											<div style="display:inline-block" title="{#options_aide_jours_grise#}" class="cursor-help tooltipster"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
											<br>
										{/section}
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label">{assign var=heuresAffichees value=$smarty.const.CONFIG_HOURS_DISPLAYED|split:","} {#options_heuresIncluses#} :</label>
				...
				<div class="tab-pane {if isset($smarty.get.tab) && $smarty.get.tab eq "param-taches"}active{/if}"" id="param-taches">
					<div class="soplanning-box">
						<form action="process/options" method="POST" class="form-horizontal">
								...
								<div class="form-group row col-md-12 align-items-center">
									...
									<div class="col-md-6">
										<select name="PLANNING_COULEUR_TACHE" class="form-control">
											...
											<option value="2" {if $smarty.const.CONFIG_PLANNING_COULEUR_TACHE eq 2}selected="selected"{/if}>{#option_couleur_taches_ressource#}</option>
											<option value="3" {if $smarty.const.CONFIG_PLANNING_COULEUR_TACHE eq 3}selected="selected"{/if}>{#option_couleur_taches_lieu#}</option>
										</select>
									</div>
						...
						<form action="process/options" method="POST" class="form-horizontal">
							...
							<fieldset>
								...
								<div class="form-group row col-md-12 align-items-center">
									...
									<div class="col-6">
										<input name="LOGOUT_REDIRECT" type="text" value="{$smarty.const.CONFIG_LOGOUT_REDIRECT|xss_protect}" class="form-control" />
									</div>
								...
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label">{#options_whitelist_upload#} :</label>
									<div class="col-6">
										<input name="WHITELIST_UPLOAD" type="text" value="{$smarty.const.CONFIG_WHITELIST_UPLOAD|xss_protect}" class="form-control" />
									</div>
									<div title="{#options_whitelist_upload_aide#}" class="cursor-help tooltipster"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
								</div>
				...
				<div class="tab-pane {if isset($smarty.get.tab) && $smarty.get.tab eq "authentication"}active{/if}" id="authentication">
					<div class="soplanning-box">
						<form action="process/options" method="POST" class="form-horizontal">
							<input type="hidden" name="tab" value="authentication">
							<input type="hidden" name="form_PASSWORD_COMPLEXITY" value="1">
							<fieldset>
								<legend>
									{#options_complexite_motdepasse#}
								</legend>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-12 col-form-label" style="font-size:13px">{#options_complexite_motdepasse_help#}</label>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-6 col-form-label">{#options_complexite_motdepasse_active#} :</label>
									<div class="col-6">
										<input type="checkbox" name="PASSWORD_COMPLEXITY" id="PASSWORD_COMPLEXITY" {if $smarty.const.CONFIG_PASSWORD_COMPLEXITY ==1}checked="checked"{/if} value="1">
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
					...
					<div class="soplanning-box">
						<form action="process/options" method="POST" class="form-horizontal">
							<input type="hidden" name="form_GOOGLE_OAUTH_ACTIVE" value="1">
							<input type="hidden" name="tab" value="authentication">
							<fieldset>
								<legend>
					...
					<div class="soplanning-box">
						<form action="process/options" method="POST" class="form-horizontal">
							<input type="hidden" name="form_GOOGLE_2FA_ACTIVE" value="1">
							<input type="hidden" name="tab" value="authentication">
							<fieldset>
								<legend>
									{#options_2fa#}
