...
<div class="container">
	<form action="stats_users" method="POST" id="formGraphe">
	...
	<div class="soplanning-box mt-2">
		<div class="row">
			<div class="col-md-12">
				...
				<img id="imgGraphe" alt="" src="graphe_users" onload="jQuery('#imgLoading').hide();jQuery('#imgGraphe').show();" style="display:none;" />
			</div>
		</div>
	</div>
