		...
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					...
					<a href="javascript:xajax_modifStatus();void(0);" class="btn btn-default" ><i class="fa fa-tags fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuCreerStatus#}</a>
				</div>
			</div>
		</div>
	</div>
				...
				{if $status|@count > 0}
					<table class="table table-striped table-hover" id="statusTab">
						...
						{foreach name=status item=statusTmp from=$status}
							<tr>
								<td class="w100">
									<a href="javascript:xajax_modifStatus('{$statusTmp.status_id}');void(0);"><i class="fa fa-pencil fa-lg fa-fw" aria-hidden="true"></i></a>
									<a href="javascript:xajax_supprimerStatus('{$statusTmp.status_id}');void(0);" onClick="javascript:return confirm('{#confirm#|escape:"javascript"}')"><i class="fa fa-trash-o fa-lg fa-fw" aria-hidden="true"></i></a>
									<a href="{$BASE}/process/planning?filtreSurStatus={$statusTmp.status_id}" title="{#planning_filtre_sur_status#|escape}"><i class="fa fa-globe fa-lg fa-fw" aria-hidden="true"></i></a>
								</td>
								<td>
