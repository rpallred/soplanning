	...
	<div class="form-group row">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="{$BASE}/projets" class="btn btn-default" ><img src="assets/img/pictos/projets.png" alt=""> {#menuListeProjets#}</a>
					<a href="{$BASE}/groupe_list" class="btn btn-default"><img src="assets/img/pictos/groupes.png" alt=""> {#menuListeGroupes#}</a>
				</div>
			</div>
		</div>
	</div>
