	...
	<div class="small-container">
		...
		{else}
			...
			{if $smarty.const.CONFIG_SOPLANNING_OPTION_ACCES ==1}
				<a href="planning?public=1">{#accesPublic#}</a> &middot;
			{/if}
			...
			<div id="divTranslation">
				<ul class="list-inline flag text-right">
					...
					<li class="list-inline-item"><a href="?language=sl" class="tooltipEvent" data-title="Slovenian"><img src="{$BASE}/assets/img/flag/sl.png" alt="Slovenian" title="Slovenian"/></a></li>
				</ul>
