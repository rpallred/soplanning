	...
	<div class="form-group row col-md-12">
		...
		<div class="col-md-6">
			<div class="form-check">
				<input class="form-check-input" type="radio" name="couleur_fond" id="couleur_fond_defaut" value="defaut" onChange="{literal}if(this.checked){document.getElementById('divSpecificColor').style.display='none';$('#couleur').val('');}{/literal}" {if $ferie.couleur eq ''}checked="checked"{/if}>
