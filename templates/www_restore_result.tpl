...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box">				
				<div class="btn-group">
					<a href="backup" class="btn btn-default"><i class="fa fa-upload fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuExport#}</a>
				</div>
				<div class="btn-group">
					<a href="restore" class="btn btn-default"><i class="fa fa-download fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuImport#}</a>
				</div>								
			</div>
		</div>
	</div>
	...
	<form action="process/restore" method="POST">
	<div class="row">
		<div class="col-md-12">
