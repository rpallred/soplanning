...
<form method="post" action="" target="_blank" name="formUser"  onSubmit="return false;">
	...
	<div class="form-group row">
		...
		<div class="col-md-5">
			<select id="langue" class="form-control" onChange="document.location='planning?language='+this.value;">
				...
				<option value="sl" {if $lang eq "sl"}selected="selected"{/if}>Slovenian</option>
			</select>
		</div>
	</div>
	{*
	...
	*}
	<input type="hidden" id="dateformat" value="fr">
	<div class="row">
