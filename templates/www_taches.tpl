	...
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="javascript:xajax_ajoutPeriode();void(0);" class="btn btn-default"><i class="fa fa-calendar-plus-o fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuAjouterPeriode#}</a>
				</div>				
			</div>
		</div>
	</div>
	{/if}
	<form action="taches" method="POST" id="filtreTaches">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="soplanning-box">
					...
					<div class="btn-group" id="taskSearchbox" >
						<div class="input-group">
							<input type="text" class="form-control input-sm" name="rechercheTaches" value="{$rechercheTaches|xss_protect|default:""}" placeholder="{#taches_groupeRecherche#}" />
					...
					{foreach from=$projets item=projet}
						...
						<tr>
							...
							<td class="w140">
								...
								{/if}
								<a href="{$BASE}/process/planning?filtreSurProjet={$projet.projet_id}" title="{#planning_filtre_sur_projet#|escape}"><i class="fa fa-calendar fa-lg fa-fw" aria-hidden="true"></i></a>
								{if $projet.lien <> ''}
								<a href="{if $projet.lien|strpos:"http" !== 0 && $projet.lien|strpos:"\\" !== 0}http://{/if}{$projet.lien|xss_protect}" title="{#winProjet_gotoLien#|escape}" target="_blank"><i class="fa fa-globe fa-lg fa-fw" aria-hidden="true"></i></a>
								{else}
								{/if}
							</td>
...
$("#filtreGroupeProjet").multiselect({
	...
	nameSuffix: 'projet',
	desactivateUrl: 'taches?desactiverFiltreGroupeProjet=1',
...
$("#filtreUser").multiselect({
	...
	noUpdatePlaceholderText:true,
	nameSuffix: 'user',
	desactivateUrl: 'taches?desactiverFiltreUser=1',
