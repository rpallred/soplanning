...
<div class="container">
	...
	<div class="small-container">
		...
		{/if}
		<form action="process/login" method="post" class="form-horizontal box">
			...
			<div class="form-group row col-md-12">
				...
				<div class="col-md-8 col-sm-8">
					<a class="btn btn-primary" href="javascript:xajax_nouveauPwd(document.getElementById('password').value);void(0);">{#changePwd#}</a>
				</div>
			</div>
		</form>
	</div>
