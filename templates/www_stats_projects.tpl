...
<div class="container">
	<form action="stats_projects" method="POST" id="formGraphe">
	...
	<div class="soplanning-box col-md-12 mt-2">
		...
		<br>
			<div class="form-group row col-md-12">
				...
				<div class="col-md-4">
					<input name="date_debut" id="date_debut" type="text" value="{if isset($stats_projects.date_debut)}{$stats_projects.date_debut}{/if}" class="form-control datepicker" />
				</div>
				...
				<div class="col-md-4">
					<input name="date_fin" id="date_fin" type="text" value="{if isset($stats_projects.date_fin)}{$stats_projects.date_fin}{/if}" class="form-control datepicker" />
				</div>
		</div>
			<div class="form-group row col-md-12">
	...
	<div class="soplanning-box mt-2">
		<div class="row">
			<div class="col-md-12">
				...
				<img id="imgGraphe" src="graphe_projects" alt="" onload="jQuery('#imgLoading').hide();jQuery('#imgGraphe').show();" style="display:none;" />
			</div>
		</div>
	</div>
